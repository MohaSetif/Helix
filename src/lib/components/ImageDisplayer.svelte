<script lang="ts">
    ...
    let btnStyle = `background-color: ${backgroundColor}; color: ${iconColor}; border: 2px solid ${borderColor}`
...
<div class="helix">
    ...
    {:else}
        ...
        <div class="container">
            ...
            <div class="btns">
                <button id="image_btn" style={btnStyle} on:click={playImagesBackward}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="m14 7l-5 5m0 0l5 5"/></svg></button>
                <button id="image_btn" style={btnStyle} on:click={togglePlayPause}>
                    {#if isPlaying}
